...
class Monde:
    ...
    def afficher(self):
        ...
        image_jour = pygame.image.load('wa-tor /wator-background.png')
        image_nuit = pygame.image.load('wa-tor /wator-background-night.png')
...
class Algue(pygame.sprite.Sprite):
    def __init__(self, x, y, monde):
        super().__init__()
        self.image = pygame.image.load('wa-tor /algue (1).png')
...
class Poisson(pygame.sprite.Sprite):
    def __init__(self, x, y, monde):
        super().__init__()
        self.image = pygame.image.load('wa-tor /poisson5 (1).png')
        self.rect = self.image.get_rect(topleft=(x, y))
        self.chronon = 0
...
class Requin(Poisson):
    def __init__(self, x, y, monde):
        ...
        self.image = pygame.image.load('wa-tor /req (3).png')
        self.rect = self.image.get_rect(topleft=(x, y))
